namespace Lime
{
	partial class Frm_main
	{
		...
		private void InitializeComponent()
		{
			...
			this.bs_user = new DevExpress.XtraBars.BarStaticItem();
			...
			// barButtonItem3
			// 
			this.barButtonItem3.Caption = "权限分配";
			...
			// barButtonItem4
			// 
			this.barButtonItem4.Caption = "数据项维护";
			...
			// barButtonItem5
			// 
			this.barButtonItem5.Caption = "服务商品及定价";
			...
			// barButtonItem7
			// 
			this.barButtonItem7.Caption = "寄存结构";
			...
			// barButtonItem8
			// 
			this.barButtonItem8.Caption = "工作站信息";
			...
			// barButtonItem9
			// 
			this.barButtonItem9.Caption = "系统升级";
			...
			// barButtonItem10
			// 
			this.barButtonItem10.Caption = "数据备份";
			...
			// barButtonItem11
			// 
			this.barButtonItem11.Caption = "进灵登记";
			...
			// barButtonItem12
			// 
			this.barButtonItem12.Caption = "登记浏览";
			...
			// barButtonItem13
			// 
			this.barButtonItem13.Caption = "临时销售";
			...
			// barButtonItem14
			// 
			this.barButtonItem14.Caption = "进灵登记查询";
			...
			// barButtonItem15
			// 
			this.barButtonItem15.Caption = "出灵数据查询";
			...
			// barButtonItem17
			// 
			this.barButtonItem17.Caption = "馆内现存";
			...
			// barButtonItem18
			// 
			this.barButtonItem18.Caption = "寄存业务";
			...
			// barButtonItem19
			// 
			this.barButtonItem19.Caption = "寄存室数据";
			...
			// barButtonItem20
			// 
			this.barButtonItem20.Caption = "寄存量统计";
			...
			// barButtonItem21
			// 
			this.barButtonItem21.Caption = "欠费数据统计";
			...
			// barButtonItem22
			// 
			this.barButtonItem22.Caption = "迁出查询统计";
			...
			// barHeaderItem1
			// 
			this.barHeaderItem1.Caption = "操作员";
			...
			// 
			this.bs_user.Id = 24;
			this.bs_user.Name = "bs_user";
			// 
			// barButtonItem23
			// 
			this.barButtonItem23.Caption = "收费日查询";
			...
			// barButtonItem24
			// 
			this.barButtonItem24.Caption = "收费作废查询";
			...
			// barButtonItem25
			// 
			this.barButtonItem25.Caption = "收款员统计";
			...
			// barButtonItem26
			// 
			this.barButtonItem26.Caption = "类别统计";
			...
			// barButtonItem27
			// 
			this.barButtonItem27.Caption = "单项统计";
			...
			// barHeaderItem2
			// 
			this.barHeaderItem2.Caption = "版本:";
			...
			this.ribbonPageGroup1.ItemLinks.Add(this.barButtonItem13, true);
			...
			this.ribbonPageGroup3.Text = "骨灰寄存业务";
			// 
			// ribbonPageGroup7
			// 
			...
			this.ribbonPageGroup7.Text = "寄存业务查询";
			// 
			// ribbonPage2
			// 
			...
			this.ribbonPageGroup4.ItemLinks.Add(this.barButtonItem24, true);
			this.ribbonPageGroup4.ItemLinks.Add(this.barButtonItem25);
			this.ribbonPageGroup4.ItemLinks.Add(this.barButtonItem26);
			this.ribbonPageGroup4.ItemLinks.Add(this.barButtonItem27);
			...
			this.ribbonPageGroup5.Text = "用户及权限管理";
			// 
			// ribbonPageGroup6
			// 
			...
			this.ribbonPageGroup6.ItemLinks.Add(this.barButtonItem7, true);
			...
			this.ribbonPageGroup6.Text = "基础信息维护";
			// 
			// ribbonStatusBar
			// 
			this.ribbonStatusBar.ItemLinks.Add(this.barHeaderItem1);
			this.ribbonStatusBar.ItemLinks.Add(this.bs_user);
			...
			this.ribbonStatusBar.Size = new System.Drawing.Size(1400, 38);
			// 
			// xtraTabControl1
			// 
			...
			this.xtraTabControl1.Size = new System.Drawing.Size(1400, 334);
			...
			this.xtraTabPage1.Size = new System.Drawing.Size(1393, 297);
			...
			this.pictureEdit1.EditValue = global::Lime.Properties.Resources.cover;
			...
			this.pictureEdit1.Size = new System.Drawing.Size(1393, 297);
		...
		private DevExpress.XtraBars.BarStaticItem bs_user;
