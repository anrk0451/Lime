namespace Lime.BusinessObject
{
	partial class DataDict
	{
		...
		private void InitializeComponent()
		{
			...
			this.colST001 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colST002 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colST003 = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			imageListBoxItemImageOptions5.SvgImage = global::Lime.Properties.Resources.bo_contract4;
			imageListBoxItemImageOptions6.SvgImage = global::Lime.Properties.Resources.bo_contract5;
            ...
            new DevExpress.XtraEditors.Controls.ImageListBoxItem("迁出原因", "", imageListBoxItemImageOptions5, null),
            new DevExpress.XtraEditors.Controls.ImageListBoxItem("收款作废原因", "", imageListBoxItemImageOptions6, null)});
			...
			this.xpCollection1.ObjectType = typeof(Lime.Xpo.orcl.ST01);
			this.xpCollection1.Session = this.unitOfWork1;
			this.xpCollection1.Sorting.AddRange(new DevExpress.Xpo.SortProperty[] {
            new DevExpress.Xpo.SortProperty("[SORTID]", DevExpress.Xpo.DB.SortingDirection.Ascending)});
			// 
			// gridView1
			// 
			...
			// colST001
			// 
			this.colST001.FieldName = "ST001";
			this.colST001.MinWidth = 25;
			this.colST001.Name = "colST001";
			this.colST001.OptionsColumn.AllowShowHide = false;
			this.colST001.Width = 94;
			// 
			// colST002
			// 
			this.colST002.FieldName = "ST002";
			this.colST002.MinWidth = 25;
			this.colST002.Name = "colST002";
			this.colST002.OptionsColumn.AllowShowHide = false;
			this.colST002.Width = 94;
			// 
			// colST003
			// 
			this.colST003.Caption = "数据项值";
			this.colST003.FieldName = "ST003";
			this.colST003.MinWidth = 25;
			this.colST003.Name = "colST003";
			this.colST003.Visible = true;
			this.colST003.VisibleIndex = 0;
			this.colST003.Width = 405;
			// 
			// colSORTID
			// 
		...
		private DevExpress.XtraGrid.Columns.GridColumn colST001;
		private DevExpress.XtraGrid.Columns.GridColumn colST002;
		private DevExpress.XtraGrid.Columns.GridColumn colST003;
