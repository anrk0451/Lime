namespace Lime.BusinessObject
{
	partial class RegisterStru
	{
		...
		private void InitializeComponent()
		{
			...
			this.列This = new DevExpress.XtraTreeList.Columns.TreeListColumn();
			this.列RG002 = new DevExpress.XtraTreeList.Columns.TreeListColumn();
			this.列RG003 = new DevExpress.XtraTreeList.Columns.TreeListColumn();
			this.列RG010 = new DevExpress.XtraTreeList.Columns.TreeListColumn();
			...
			this.列RG030 = new DevExpress.XtraTreeList.Columns.TreeListColumn();
			this.列RG031 = new DevExpress.XtraTreeList.Columns.TreeListColumn();
			this.列RG033 = new DevExpress.XtraTreeList.Columns.TreeListColumn();
			this.列STATUS = new DevExpress.XtraTreeList.Columns.TreeListColumn();
			this.xpCollection_rg01 = new DevExpress.Xpo.XPCollection(this.components);
			...
			this.xpCollection_ly01 = new DevExpress.Xpo.XPCollection(this.components);
			((System.ComponentModel.ISupportInitialize)(this.barManager1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.splitContainerControl1)).BeginInit();
			this.splitContainerControl1.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.treeList1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.xpCollection_rg01)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.xpCollection_ly01)).BeginInit();
			this.SuspendLayout();
			// 
			// barManager1
			// 
			...
			this.barSubItem1.ImageOptions.SvgImage = global::Lime.Properties.Resources.actions_addcircled2;
			...
			// barButtonItem9
			// 
			this.barButtonItem9.Caption = "同级节点";
			...
			// barButtonItem10
			// 
			this.barButtonItem10.Caption = "子节点";
			...
			// barButtonItem11
			// 
			this.barButtonItem11.Caption = "层定价";
			this.barButtonItem11.Id = 11;
			this.barButtonItem11.ImageOptions.SvgImage = global::Lime.Properties.Resources.charttype_gantt;
			...
			this.barButtonItem7.ImageOptions.SvgImage = global::Lime.Properties.Resources.moveup;
			this.barButtonItem7.Name = "barButtonItem7";
			toolTipItem3.Text = "上移";
			...
			this.barButtonItem8.ImageOptions.SvgImage = global::Lime.Properties.Resources.movedown;
			this.barButtonItem8.Name = "barButtonItem8";
			toolTipItem4.Text = "下移";
			...
			// treeList1
			// 
			this.treeList1.ActiveFilterString = "[STATUS] <> \'0\'";
			...
			this.treeList1.DataSource = this.xpCollection_rg01;
			...
			// 列This
			// 
			this.列This.FieldName = "This";
			this.列This.Name = "列This";
			this.列This.Visible = true;
			this.列This.VisibleIndex = 0;
			// 
			// 列RG002
			// 
			this.列RG002.FieldName = "RG002";
			this.列RG002.Name = "列RG002";
			this.列RG002.Visible = true;
			this.列RG002.VisibleIndex = 1;
			// 
			// 列RG003
			// 
			this.列RG003.FieldName = "RG003";
			this.列RG003.Name = "列RG003";
			this.列RG003.Visible = true;
			this.列RG003.VisibleIndex = 0;
			// 
			// 列RG010
			// 
			this.列RG010.FieldName = "RG010";
			this.列RG010.Name = "列RG010";
			this.列RG010.Visible = true;
			this.列RG010.VisibleIndex = 3;
			// 
			// 列RG011
			// 
			this.列RG011.FieldName = "RG011";
			this.列RG011.Name = "列RG011";
			this.列RG011.Visible = true;
			this.列RG011.VisibleIndex = 4;
			// 
			// 列RG020
			// 
			this.列RG020.FieldName = "RG020";
			this.列RG020.Name = "列RG020";
			this.列RG020.Visible = true;
			this.列RG020.VisibleIndex = 5;
			// 
			// 列RG021
			// 
			this.列RG021.FieldName = "RG021";
			this.列RG021.Name = "列RG021";
			this.列RG021.Visible = true;
			this.列RG021.VisibleIndex = 6;
			// 
			// 列RG030
			// 
			this.列RG030.FieldName = "RG030";
			this.列RG030.Name = "列RG030";
			this.列RG030.Visible = true;
			this.列RG030.VisibleIndex = 7;
			// 
			// 列RG031
			// 
			this.列RG031.FieldName = "RG031";
			this.列RG031.Name = "列RG031";
			this.列RG031.Visible = true;
			this.列RG031.VisibleIndex = 8;
			// 
			// 列RG033
			// 
			this.列RG033.FieldName = "RG033";
			this.列RG033.Name = "列RG033";
			this.列RG033.Visible = true;
			this.列RG033.VisibleIndex = 9;
			// 
			// 列STATUS
			// 
			this.列STATUS.FieldName = "STATUS";
			this.列STATUS.Name = "列STATUS";
			this.列STATUS.Visible = true;
			this.列STATUS.VisibleIndex = 10;
			// 
			// xpCollection_rg01
			// 
			this.xpCollection_rg01.CriteriaString = "[STATUS] = \'1\'";
			this.xpCollection_rg01.LoadingEnabled = false;
			...
			// xpCollection_bi01
			// 
			this.xpCollection_bi01.LoadingEnabled = false;
			this.xpCollection_bi01.ObjectType = typeof(Lime.Xpo.orcl.BI01);
			this.xpCollection_bi01.Session = this.unitOfWork1;
			// 
			// xpCollection_ly01
			// 
			this.xpCollection_ly01.LoadingEnabled = false;
			this.xpCollection_ly01.ObjectType = typeof(Lime.Xpo.orcl.LY01);
			this.xpCollection_ly01.Session = this.unitOfWork1;
			// 
			// RegisterStru
			// 
			...
			this.Size = new System.Drawing.Size(1175, 675);
			this.Load += new System.EventHandler(this.RegisterStru_Load);
			((System.ComponentModel.ISupportInitialize)(this.barManager1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.splitContainerControl1)).EndInit();
			this.splitContainerControl1.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.treeList1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.xpCollection_rg01)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.xpCollection_ly01)).EndInit();
		...
		private DevExpress.Xpo.XPCollection xpCollection_rg01;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列This;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列RG002;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列RG003;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列RG010;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列RG011;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列RG020;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列RG021;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列RG030;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列RG031;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列RG033;
		private DevExpress.XtraTreeList.Columns.TreeListColumn 列STATUS;
		private DevExpress.Xpo.UnitOfWork unitOfWork1;
		private DevExpress.XtraGrid.GridControl gridControl1;
		private DevExpress.XtraGrid.Views.Grid.GridView gridView1;
		private DevExpress.Xpo.XPCollection xpCollection_bi01;
		private DevExpress.Xpo.XPCollection xpCollection_ly01;
