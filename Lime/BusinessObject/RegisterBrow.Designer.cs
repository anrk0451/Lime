namespace Lime.BusinessObject
{
	partial class RegisterBrow
	{
		...
		private void InitializeComponent()
		{
			...
			this.barSubItem1.ImageOptions.SvgImage = global::Lime.Properties.Resources.actions_addcircled6;
			...
			// barButtonItem3
			// 
			this.barButtonItem3.Caption = "外来寄存";
			...
			// barButtonItem4
			// 
			this.barButtonItem4.Caption = "原始寄存登记";
			this.barButtonItem4.Id = 5;
			this.barButtonItem4.Name = "barButtonItem4";
			// 
			// barButtonItem5
			// 
			this.barButtonItem5.Caption = "修改";
			...
			// barButtonItem6
			// 
			this.barButtonItem6.Caption = "缴费";
			...
			// barButtonItem7
			// 
			this.barButtonItem7.Caption = "迁出";
			...
			// barButtonItem10
			// 
			this.barButtonItem10.Caption = "刷新";
			...
			// barButtonItem11
			// 
			this.barButtonItem11.Caption = "导出";
			...
			// barStaticItem2
			// 
			this.barStaticItem2.Caption = "        记录范围";
			...
			this.barDockControlTop.Size = new System.Drawing.Size(1481, 36);
			// 
			...
			this.barDockControlRight.Location = new System.Drawing.Point(1481, 36);
            ...
            this.lookup_ac052,
            this.lookup_ac100});
			this.gridControl1.Size = new System.Drawing.Size(1481, 667);
			...
			// gridColumn7
			// 
			this.gridColumn7.Caption = "寄存证号";
			this.gridColumn7.FieldName = "RC109";
            ...
            new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "RC001", "共{0}条记录")});
			...
			this.gridColumn10.FieldName = "RC050";
			...
			this.gridColumn12.FieldName = "RC100";
