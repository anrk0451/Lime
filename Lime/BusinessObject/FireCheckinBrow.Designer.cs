namespace Lime.BusinessObject
{
	partial class FireCheckinBrow
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FireCheckinBrow));
			...
			this.lookup_ac006 = new DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit();
            ...
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.Width, this.barEditItem1, "", false, true, true, 191)});
			...
			// barButtonItem5
			// 
			this.barButtonItem5.Caption = "业务办理";
			this.barButtonItem5.Id = 7;
			this.barButtonItem5.ImageOptions.Image = global::Lime.Properties.Resources.boorderitem_16x16;
			this.barButtonItem5.ImageOptions.LargeImage = global::Lime.Properties.Resources.boorderitem_32x32;
			...
			this.barButtonItem6.ImageOptions.SvgImage = global::Lime.Properties.Resources.open21;
			...
			// barHeaderItem1
			// 
			this.barHeaderItem1.Caption = "记录范围";
			...
			this.barDockControlTop.Size = new System.Drawing.Size(1321, 36);
			// 
			...
			this.barDockControlRight.Location = new System.Drawing.Point(1321, 36);
            ...
            this.lookup_ac100,
            this.lookup_ac006});
			this.gridControl1.Size = new System.Drawing.Size(1321, 606);
			...
			// gridColumn6
			// 
			this.gridColumn6.Caption = "死亡时间";
			this.gridColumn6.FieldName = "AC010";
			this.gridColumn6.Name = "gridColumn6";
			this.gridColumn6.Width = 100;
			// 
			// gridColumn7
			// 
			this.gridColumn7.Caption = "死亡原因";
			this.gridColumn7.FieldName = "AC005";
			...
			this.gridColumn9.FieldName = "AC052";
			...
			// gridColumn12
			// 
			this.gridColumn12.Caption = "经办人";
			this.gridColumn12.ColumnEdit = this.lookup_ac100;
			this.gridColumn12.FieldName = "AC100";
			...
			// gridColumn13
			// 
			this.gridColumn13.Caption = "登记时间";
			this.gridColumn13.FieldName = "AC200";
			...
			// gridColumn17
			// 
			this.gridColumn17.Caption = "联系地址";
			this.gridColumn17.FieldName = "AC055";
			...
			// gridColumn4
			// 
			this.gridColumn4.Caption = "骨灰处理";
			this.gridColumn4.ColumnEdit = this.lookup_ac006;
			this.gridColumn4.FieldName = "AC006";
			...
			// lookup_ac006
			// 
			this.lookup_ac006.AutoHeight = false;
			this.lookup_ac006.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.lookup_ac006.Name = "lookup_ac006";
			this.lookup_ac006.NullText = "";
			// 
			...
			this.Name = "FireCheckinBrow";
			this.Size = new System.Drawing.Size(1321, 642);
			this.Load += new System.EventHandler(this.FireCheckinBrow_Load);
